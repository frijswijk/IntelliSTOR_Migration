@echo off
REM compile.bat - Compile papyrus_extract_folder_species.exe
REM This batch file compiles the C++ extractor for folder hierarchy and report species
...
set CPP_FILE=%~dp0papyrus_extract_folder_species.cpp
set OUTPUT=%~dp0papyrus_extract_folder_species.exe

echo ======================================================================
echo Compiling Papyrus Folder and Species Extractor
echo ======================================================================
