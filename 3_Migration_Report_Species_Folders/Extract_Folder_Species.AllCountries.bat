...
set FLAG=All countries from folder description
echo Extract_Folder_Species_MY Script started at: %DATE% %START_TIME%
echo ---------------------------------------------------------------------------
rem python Extract_Folder_Species.py --server localhost --database iSTSGUAT --windows-auth --output-dir outputMY --Country MY or --County 0 for all
python Extract_Folder_Species.py --server %SQLServer% --database %SQL-MY-Database% --windows-auth --output-dir %ReportSpecies_MY% --Country 0
