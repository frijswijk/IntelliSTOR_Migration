...
set "START_TIME=%TIME%"
set "LOG_FILE=Extract_ReportSpecies_Folders_SG_LOG.txt"

echo Extract_Folder_Species_SG Script started at: %DATE% %START_TIME%
echo ---------------------------------------------------------------------------
rem python Extract_Folder_Species.py --server localhost --database iSTSGUAT --windows-auth --output-dir outputSG --Country SG
python Extract_Folder_Species.py --server %SQLServer% --database %SQL-SG-Database% --windows-auth --output-dir %ReportSpecies_SG% --Country SG
