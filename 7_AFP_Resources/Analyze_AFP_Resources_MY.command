#!/bin/bash
# Analyze AFP Resources - Malaysia
# macOS equivalent of Analyze_AFP_Resources_MY.bat
...
LOG_FILE="Analyze_AFP_Resources_MY_LOG.txt"
NAMESPACE="MY"
# NAMESPACE="DEFAULT"

echo "Analyze_AFP_Resources_MY Script started at: ${START_TIME}"
echo "-----------------------------------------------------------------------"
...
CMD="python3 Analyze_AFP_Resources.py --folder \"${AFP_Source_MY}\" --output-csv \"${AFP_Output}/AFP_Resources_MY.csv\" --namespace ${NAMESPACE} --quiet"
...
# --- 3. Logging Section ---
echo "[${START_TIME}] Country: MY | Source: ${AFP_Source_MY} | Namespace: ${NAMESPACE} | VersionCompare: ${AFP_VersionCompare} | FromYear: ${AFP_FromYear} | AllNameSpaces: ${AFP_AllNameSpaces} | Duration: ${DURATION}" >> "${LOG_FILE}"
