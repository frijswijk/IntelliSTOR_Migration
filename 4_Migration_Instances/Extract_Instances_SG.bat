...
python Extract_Instances.py --server %SQLServer% --database %SQL-SG-Database% --windows-auth --input "%Instances_Input_SG%" --output "%Instances_Output_SG%" --start-year %Instances_StartYear_SG% --quiet
