// papyrus_rpt_page_extractor_v3.cpp - RPT extractor with QPDF library integration
//
// Standalone C++17 CLI tool for Papyrus shell method calls with enhanced watermark support.
// Based on v2 but links QPDF as a C++ library - zero external process calls, fully self-contained.
//
// Compile: See compile_v3.bat (requires QPDF development files)
//
// Usage: papyrus_rpt_page_extractor_v3.exe <input_rpt> <selection_rule> <output_txt> <output_binary> [watermark_options]
//
...
//     papyrus_rpt_page_extractor_v3.exe input.rpt all output.txt output.pdf
//
//   With centered watermark at 30% opacity:
//     papyrus_rpt_page_extractor_v3.exe input.rpt pages:1-10 output.txt output.pdf --WatermarkImage logo.png
//
//   With custom watermark settings:
//     papyrus_rpt_page_extractor_v3.exe input.rpt all output.txt output.pdf --WatermarkImage confidential.png --WatermarkPosition TopRight --WatermarkOpacity 50 --WatermarkRotation 45 --WatermarkScale 0.8
//
// Dependencies:
